$(function () {
    ...
    var avatarUpload = '/user/avatarUpload'
    var avatarSave = '/user/avatarSave'
    ...
    function uploadFile(cas) {
        ...
        $.ajax({
            url: avatarUpload,
            type: 'get',
            success: function (responseUploadAvatarDto) {
                if (responseUploadAvatarDto.success) {
                    var fileUrl = responseUploadAvatarDto.fileUrl
                    var avatarHost = responseUploadAvatarDto.host
                    cas.toBlob(function (blob) {
                        var formData = new FormData();   //这里连带form里的其他参数也一起提交了,如果不需要提交其他参数可以直接FormData无参数的构造函数
                        formData.append('OSSAccessKeyId', responseUploadAvatarDto.accessKeyId);
                        formData.append('policy', responseUploadAvatarDto.policy);
                        formData.append('signature', responseUploadAvatarDto.signature);
                        formData.append('key', responseUploadAvatarDto.filename);
