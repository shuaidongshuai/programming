...
public class Utils {
	...
	static {
		beauty.put("1", new Beauty("赵丽颖","10000",1));
		beauty.put("2", new Beauty("赵奕欢","1000",1));
		beauty.put("3", new Beauty("金莎","12000",1));
		beauty.put("4", new Beauty("杨幂","5000",1));
		beauty.put("5", new Beauty("郑爽","6000",1));
	}
