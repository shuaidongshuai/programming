...
<html>
  ...
  <body background="images/topbackground2.jpg">
  	<p align="center" >
  		<font size="50" color="red">欢迎来到go窝</font>
  	</p>
  	<div id="d">
	    ...
	    <a href="reg.jsp" id="reg"><font size="20" color="blue">注册</font></a>
	  	...
	  	<c:if test="${not empty u }">
	  		...
	  		<a href="${pageContext.request.contextPath }/zuoya.html"><font size="20" color="red">进入主页</font></a>
